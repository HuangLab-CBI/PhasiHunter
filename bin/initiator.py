...
if __name__ == '__main__':
    ...
    for arg in range(len(sys.argv)):
        if sys.argv[arg]=='-i':
            ...
            print('by Ji Huang, Crop Bioinformatics Group, NJAU, version 0.122, 2018/09/19')
            print(' -i  [str]the file generated by SPHASE.py with -o, required.')
            print(' -j  [str]the target predicted by psRNAtarget server')
            ...
            print(' -pl [int]21 or 24, the phase length of 21 or 24, required')
    ...
    if phaselength == 0 or inputfile=='' or outputfilename=='' or psRNAtarget=='':
        print('Please input all necessary parameters, type python sphase-ini.py -h for help.')
        sys.exit()
